...
if("Connected: No" in out):
    ...
    print("<div class='container adjust' style='padding-left: 205px; !important'><div class='bend bend-lft'><div class='icon icon-lft'><img src='dive/ics/14note.png' height='10px'></div><div class='content content-lft'>" + spot + "</div></div></div></div>")
